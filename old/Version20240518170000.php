...
/**
 * This migration adds the column poll_is_recursive in the poll table
 *
 * @package Framadate\Migration
 * @version 1.2
 */
class Version20240518170000 extends AbstractMigration
{
    /**
    ...
    {
        return 'Add column poll_is_recursive in table poll';
    }
    ...
    public function up(Schema $schema)
    {
        ...
        $poll->addColumn('poll_is_recursive', 'boolean', ['default' => false]);
    }
    ...
    {
        $poll = $schema->getTable(Utils::table('poll'));
        $poll->dropColumn('poll_is_recursive');
    }
}
